...
import { L1ToL2MessageReader, L1ToL2MessageStatus, L2ToL1MessageStatus as OutgoingMessageState } from '@arbitrum/sdk';
...
export declare type NodeBlockDeadlineStatus = number | 'NODE_NOT_CREATED';
...
export declare type WithdrawalInitiated = WithdrawalInitiatedEvent['args'] & {
    txHash: string;
};
...
export interface ArbTokenBridgeToken {
    ...
    deposit: (erc20Address: string, amount: BigNumber) => Promise<void | ContractReceipt>;
    withdraw: (erc20l1Address: string, amount: BigNumber) => Promise<void | ContractReceipt>;
    triggerOutbox: (id: string) => Promise<void | ContractReceipt>;
...
export interface TransactionActions {
    ...
    updateTransaction: (txReceipt: TransactionReceipt, tx?: ethers.ContractTransaction, seqNum?: number, l1ToL2MsgData?: L1ToL2MessageData) => void;
...
} & Pick<TransactionActions, 'addTransaction' | 'clearPendingTransactions' | 'setTransactionConfirmed' | 'updateTransaction' | 'addTransactions' | 'fetchAndUpdateL1ToL2MsgStatus'>;
